...
OpenLayers.Util.extend(OpenLayers.Lang.fr, {
    ...
    "btn.refresh.tooltip": "Forcer un rechargement des tuiles (cela se produit toutes les 5 minutes)",
    "displayzone.title.prefix": "Tuile",
    "displayzone.defaulttext": "L'information sur les tuiles sera affichée ici...",
    ...
    'displayzone.tbar.reserve.tooltip': "Réserver cette tuile (contour jaune).<br />Ensuite, commencez l'édition avec les boutons suivants",
